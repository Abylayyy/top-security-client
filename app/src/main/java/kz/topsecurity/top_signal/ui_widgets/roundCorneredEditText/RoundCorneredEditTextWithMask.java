...
public class RoundCorneredEditTextWithMask extends RoundCorneredEditText  implements TextWatcher {
    ...
    public RoundCorneredEditTextWithMask(Context context) {
        super(context);
        init();
    }

    public RoundCorneredEditTextWithMask(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();

        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RoundCorneredEditTextWithMask);
        mask = attributes.getString(R.styleable.RoundCorneredEditTextWithMask_mask);

        allowedChars = attributes.getString(R.styleable.RoundCorneredEditTextWithMask_allowed_chars);
        deniedChars = attributes.getString(R.styleable.RoundCorneredEditTextWithMask_denied_chars);

        String representation = attributes.getString(R.styleable.RoundCorneredEditTextWithMask_char_representation);
        ...
        keepHint = attributes.getBoolean(R.styleable.RoundCorneredEditTextWithMask_keep_hint, false);
...
//        });
    ...
    public RoundCorneredEditTextWithMask(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        super.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus()) {
                    ...
                    RoundCorneredEditTextWithMask.this.setSelection(lastValidPosition());
                }
            }
        });
    }
